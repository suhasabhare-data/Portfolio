...
| Project | Tools Used | Area of Analysis | Description |
|--------|-------------|------------------|-------------|
| [MySQL Case Studies](#) | MySQL | Data Analysis, Data Cleaning, Data Exploration | Solutions to selected case studies from the [#8WeekSQLChallenge](https://8weeksqlchallenge.com), demonstrating advanced SQL query writing, data wrangling, and analytical thinking. |
...
- 📊 Forecasting and regression modeling in Tableau
- 🧠 Strategic recommendations based on financial and behavioral data
- 🎥 Storytelling and video presentations for public policy and business growth
